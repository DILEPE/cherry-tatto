...
from app.infrastructure.store_repository import StoreRepository
...
store_repo = StoreRepository(db_mgr)
...
business_service = BusinessLogicService(
    repo, customer_repo, notifier, panel_user_repo, store_repo
)
