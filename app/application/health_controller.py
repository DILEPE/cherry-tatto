...
from app.infrastructure.n8n_health import (
    n8n_echo_fields_from_upstream,
    probe_n8n_from_env,
    probe_url_configured_from_env,
)
...
class HealthController(Controller):
    ...
    async def n8n_upstream(self) -> Response:
        ...
        echo = n8n_echo_fields_from_upstream(result.upstream_json)
