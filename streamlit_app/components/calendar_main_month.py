...
from streamlit_app.components.calendar_month_footer import calendar_month_footer_strip_html
...
def render_main_calendar(
    ...
    *,
    ...
    """Vista principal: mes con citas por día; acciones vía enlaces `?cal_*` en el HTML."""
